...
#Region "Methods - Non public"
    ...
    Friend Sub ImportOwner(ByVal ownerType As Type)
        ...
        MyOwnerImport = New TypeImport(ownerType, BindingFlags.Public Or BindingFlags.NonPublic Or BindingFlags.Instance Or BindingFlags.Static Or BindingFlags.FlattenHierarchy, False)
...
#Region "Methods - Public"
	...
	Public Sub AddType(ByVal t As Type, ByVal ns As String)
        ...
        'Aricie
        import.Add(New TypeImport(t, BindingFlags.Public Or BindingFlags.Static Or BindingFlags.FlattenHierarchy, False))
	End Sub
	...
	Public Sub AddMethod(ByVal methodName As String, ByVal t As Type, ByVal ns As String)
        ...
        Dim mi As MethodInfo = t.GetMethod(methodName, BindingFlags.Public Or BindingFlags.Static Or BindingFlags.IgnoreCase Or BindingFlags.FlattenHierarchy)
