...
#Region "Methods - Internal"
		...
		Friend Sub EmitLoad(ByVal tailName As String, ByVal ilg As FleeILGenerator)
            ...
            Dim methods As MemberInfo() = GetType(CalculationEngine).FindMembers(MemberTypes.Method, BindingFlags.Instance Or BindingFlags.Public Or BindingFlags.FlattenHierarchy, Type.FilterNameIgnoreCase, "GetResult")
