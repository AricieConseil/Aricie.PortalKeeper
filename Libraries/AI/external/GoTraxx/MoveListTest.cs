...
namespace GoTraxx
{
	...
	public class MoveListTest
	{
		...
		public void QuickSort()
		{
			...
			Assert.AreEqual(CoordinateSystem.AtFromSGF("D2", lBoardSize), lMoveList[5]);
			Assert.AreEqual(CoordinateSystem.AtFromSGF("A3", lBoardSize), lMoveList[4]);
			Assert.AreEqual(CoordinateSystem.AtFromSGF("C4", lBoardSize), lMoveList[3]);
			Assert.AreEqual(CoordinateSystem.AtFromSGF("A5", lBoardSize), lMoveList[2]);
			Assert.AreEqual(CoordinateSystem.AtFromSGF("A6", lBoardSize), lMoveList[1]);
			Assert.AreEqual(CoordinateSystem.AtFromSGF("E1", lBoardSize), lMoveList[0]);
		}
