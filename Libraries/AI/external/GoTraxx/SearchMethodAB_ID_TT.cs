...
namespace GoTraxx
{
	class SearchMethodAB_ID_TT : SearchMethod, ISearchMethodInterface
	{
		...
		public SearchMethodAB_ID_TT(ISearchInterface searchInterface)
		...
		protected void Think(Color playerToMove)
		{
			...
			{
				SearchComplete = true;
				lBestValue = Search(playerToMove, lDepth, 0, SearchOptions .AlphaValue, SearchOptions.BetaValue);
