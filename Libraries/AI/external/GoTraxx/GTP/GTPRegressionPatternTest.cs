...
{
	[TestFixture]
	public class GTPRegressionPatternTest
	{
		class RegressionTest
		{
			public string Pattern;
			public string Input;
			public GTPRegressionResult ExpectedResult;

			public RegressionTest(string pattern, string pInput, GTPRegressionResult pExpectedResult)
			{
				Pattern = pattern;
				Input = pInput;
