...
namespace GoTraxx
{
    public static class GameRecordBoardAdapter
	{
		...
		public static bool Apply(GameRecord gameRecord, GoBoard goBoard, bool undoable)
		{
			return Apply(gameRecord, goBoard, undoable, -1);
		}

		public static bool Apply(GameRecord gameRecord, GoBoard goBoard)
		{
			return Apply(gameRecord, goBoard, false, -1);
		}
