...
namespace GoTraxx
{
	class PatternCollection : ErrorManagement
	{
		...
		public Pattern FindByKey(string uniquePatternName)
		{
			foreach (Pattern lPattern in Patterns)
				if (lPattern.UniquePatternName == uniquePatternName)
					return lPattern;
