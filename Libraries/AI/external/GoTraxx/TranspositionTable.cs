...
namespace GoTraxx
{
	class TranspositionTable
	{
		...
		public static Node EmptyNode = new Node(0, 0, NodeType.Unknown, 0);
		...
		public struct Node
		{
			...
			public Node(int height, int value, NodeType flag, Int64 zobristKey)
			{
				Height = (byte)height;
				Value = value;
				Flag = flag;
		...
		public void Record(int height, int value, NodeType flag, ZobristHash zobristKey)
		{
